        ...
        <div className={style.container}>
            <div className={style.form_container}>
                ...
                <form className={style.form} onSubmit={e => onSubmit(e)}>
                    ...
                    <div className={style.field}>
                        <button disabled={loading} style={{ backgroundColor: (loading ? "rgb(156 163 175)" : "rgb(59 130 246)") }} className={style.btn} type='submit'>Login</button>
                    </div>
                </form>
                <div className='text-sm'>
                    Don't have an account?<Link className='ml-2 text-blue-500' to="/register">Sign up!</Link>
                </div>
            </div>
        </div>
    )
